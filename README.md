...
|-------------------------------------- |--------------|----------------------|--------------------------|---------|         
| Up-to-date requirements.txt           | NF           |   Dariana            |   X      | | 
| `ML/detect-features`                  | FN           |   Dariana            |   X      | |
| `ML/artifact`                         | NF           |   Dariana            |   X      | |
| `ML/feature`                          | NF           |   Dariana            |   X      | |
| `ML/metric`                           | NF           |   Dariana            |   X      | |
| `ML/metric/extensions`                | FN           |   Dariana            |   X      | |
| `ML/model`                            | NF           |   Dariana            |   X      | |
| `ML/model/extensions`                 | FN           |   Dariana            |   X      | |
| `ML/pipeline/evaluation`              | FN           |   Dariana            |   X      | | 
| `ST/page/datasets`                    | NF           |   Dariana            |   X      | |
| `ST/datasets/management/create`       | FN           |   Dariana            |   X      | |
| `ST/datasets/management/save`         | FN           |   Dariana            |   X      | |
| `ST/page/modelling`                   | NF           |   Dariana            |   X      | |
| `ST/modelling/datasets/list`          | FN           |   Dariana            |   X      | |
| `ST/modelling/datasets/features`      | FN           |   Dariana            |   X      | |
| `ST/modelling/models`                 | FN           |   Dariana            |   X      | |
| `ST/modelling/pipeline/split`         | FN           |   Dariana            |   X      | |
| `ST/modelling/pipeline/metrics`       | FN           |   Dariana            |   X      | |
| `ST/modelling/pipeline/summary`       | FN           |   Dariana            |   X      | |
| `ST/modelling/pipeline/train`         | FN           |   Dariana            |   X      | |
| `ST/modelling/pipeline/save`          | FN           |   Dariana            |   X      | |
| `ST/page/deployment`                  | FN           |   Dariana            |   X      | |
| `ST/deployment/load`                  | FN           |   Dariana            |   X      | |
